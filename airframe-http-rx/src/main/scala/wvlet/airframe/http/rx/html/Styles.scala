...
import wvlet.airframe.http.rx.html.Styles.{
  AutoStyle,
  BorderRadius,
  BorderStyle,
  BorderWidth,
...
object Styles {
  ...
  /**
    ...
    */
  private[html] class AutoStyle(jsName: String, cssName: String) extends Style(jsName, cssName) {
    lazy val auto = this -> "auto"
  }

  private[html] class PixelAutoStyle(jsName: String, cssName: String) extends PixelStyle(jsName, cssName) {
    lazy val auto = this -> "auto"
  }
  ...
  /**
    ...
    */
  private[html] class NoneOpenStyle(jsName: String, cssName: String) extends Style(jsName, cssName) {
  ...
  /**
    ...
    */
  private[html] class NormalOpenStyle(jsName: String, cssName: String) extends Style(jsName, cssName) {
    lazy val normal = this -> "normal"
  }

  private[html] class MultiImageStyle(jsName: String, cssName: String) extends Style(jsName, cssName)

  private[html] class CurrentColor(jsName: String, cssName: String) extends Style(jsName, cssName) {
    lazy val currentColor = this -> "currentColor"
  }

  private[html] class OutlineStyle(jsName: String, cssName: String) extends Style(jsName, cssName) {
  ...
  private[html] class BorderStyle(jsName: String, cssName: String) extends OutlineStyle(jsName, cssName) {
  ...
  private[html] class Overflow(jsName: String, cssName: String) extends Style(jsName, cssName) {
  ...
  private[html] class PageBreak(jsName: String, cssName: String) extends Style(jsName, cssName) {
  ...
  private[html] class BorderRadius(jsName: String, cssName: String) extends PixelStyle(jsName, cssName)

  private[html] trait MarginAuto extends PixelStyle {
  ...
  private[html] class BorderWidth(jsName: String, cssName: String) extends Style(jsName, cssName) {
    lazy val thin   = this -> "thin"
    lazy val medium = this -> "medium"
    lazy val thick  = this -> "thick"
  }

  private[html] class MultiTimeStyle(jsName: String, cssName: String) extends Style(jsName, cssName)

  private[html] class MinLengthStyle(jsName: String, cssName: String) extends PixelAutoStyle(jsName, cssName) {
  ...
  private[html] class MaxLengthStyle(jsName: String, cssName: String) extends PixelStyle(jsName, cssName) {
...
object StylesExtra {
  ...
  /**
    ...
    *
      * MDN
    */
  object columnRuleStyle extends OutlineStyle("columnRuleStyle", "column-rule-style") {
    lazy val hidden = this -> "hidden"
  }
